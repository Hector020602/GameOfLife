...
public class Board extends javax.swing.JPanel {
    ...
    private void paintCells(Graphics g, Dimensions d) {
            ...
            for (int col = 0; col < d.numCols; col++) {
                if (viewModelMatrix.isAlive(row, col)) {
                     g.fillRect(d.leftMargin + col * d.squareWidth,
                        d.upperMargin + row * d.squareHeight, d.squareWidth, d.squareHeight);
                }
     ...
     private void paintBackground(Graphics g, Dimensions d) {
        ...
        for (int row = 0; row < d.numRows; row ++) {
            g.drawLine(d.leftMargin, d.upperMargin + row * d.squareHeight, d.realWidth + d.leftMargin,d.upperMargin + row * d.squareHeight );
        }
        for (int col = 0; col < d.numCols; col ++) {
            g.drawLine(d.leftMargin + col * d.squareWidth, d.upperMargin, d.leftMargin + col * d.squareWidth, d.upperMargin + d.realHeight);
        }
